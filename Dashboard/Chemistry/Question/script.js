window.onload = function(){
    fetch("https://edu-foundation-kudos-dot-com.vercel.app/api/chapter/chapter/chemistry",{
        method: "GET"
    })
    ...
    .then(json => {
        ...
        topic.map(e =>{
            ...
            document.getElementById("ChemDrop").appendChild(node).className="dropdown-item";
        })
    });
};
